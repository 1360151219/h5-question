  ...
  <div>
    <div class="bg">
      ...
      <div
        ...
        @click="
          !isNew
            ? clickToNext(3, 3, '/two', 1.323)
            : clickToNext(2, 5, '/two', 1.323)
        "
      ></div>
      <div
        ...
        @click="
          !isNew
            ? clickToNext(2, 0, '/two', 1.323)
            : clickToNext(3, 2, '/two', 1.323)
        "
      ></div>
      <div
        ...
        @click="
          !isNew
            ? clickToNext(4, 2, '/two', 1.323)
            : clickToNext(3, 1, '/two', 1.323)
        "
      ></div>
